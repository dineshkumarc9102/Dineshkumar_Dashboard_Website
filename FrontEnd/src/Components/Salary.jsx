    ...
    if (iframeRef.current) {
      ...
      toast.custom(() => (
        <div className="flex items-center gap-2 bg-[#162b3d] text-white px-4 py-2 rounded-lg shadow">
          ...
          <span>Refreshing salary dashboard</span>
        </div>
      ));
    }
  };
  ...
  const handleOpen = () => {
    ...
    toast.custom(() => (
      <div className="flex items-center gap-2 bg-[#162b3d] text-white px-4 py-2 rounded-lg shadow">
        ...
        <span>Opened salary dashboard</span>
      </div>
    ));
  };
      ...
      <div className="flex-1 p-2">
        <div className="w-full h-full border-2 border-gray-600 rounded-xl overflow-hidden">
          ...
          <iframe
            ref={iframeRef}
            src={
              import.meta.env.VITE_POWERBI_SALARY
                ? `${import.meta.env.VITE_POWERBI_SALARY}&filterPaneEnabled=false`
                : ""
            }
